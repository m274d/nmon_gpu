...
# nmon_power_rhel8: $(FILE)
# 	gcc -o nmon_power_rhel8 $(FILE) $(CFLAGS) $(LDFLAGS) -D POWER -D RHEL7
...
nmon_AMD64_ubuntu1804: lmon.c
	cc -o nmon_AMD64_ubuntu1804 $(FILE) $(CFLAGS) $(LDFLAGS) -D X86 -D NVIDIA_GPU -lnvidia-ml -D UBUNTU
